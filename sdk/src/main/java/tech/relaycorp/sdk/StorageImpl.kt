...
import tech.relaycorp.sdk.persistence.Persistence
...
@Inject constructor(
    ...
    suspend fun getCertificate(endpoint: String) =
        persistence.get("certificate_$endpoint")?.let(Certificate::deserialize)
    ...
    suspend fun getGatewayCertificate() =
        persistence.get("gateway_certificate")?.let(Certificate::deserialize)
